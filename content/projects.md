...
Catálogo dos meus projetos open-source, publicações oficiais na Microsoft, guias de estudo, contribuições à comunidade e ferramentas. Tudo que construí ao longo de quase 20 anos trabalhando com infraestrutura e cloud.

O log completo e sempre atualizado está no [Activity Log](https://github.com/ricmmartins/activitylog).
...
|---------|-----------|------|
| AKS Learning | Do zero à produção no Azure Kubernetes Service. Networking, segurança, observabilidade, escalabilidade, GitOps, workloads AI/ML e boas práticas | [aks-learning.github.io](https://aks-learning.github.io/) |
...
| Azure Cert Prep | 205 desafios hands-on cobrindo 5 exames de certificação Microsoft (AZ-900, AZ-104, AZ-305, AZ-400, SC-500). 100% de cobertura dos exames com comandos validados, cenários break-and-fix e labs com um clique no GitHub Codespaces. Gratuito e open-source | [azurecertprep.github.io](https://azurecertprep.github.io/) |
| Azure Governance Made Simple | Ebook com 30 capítulos sobre identidade, policy, IaC, custo, observabilidade e governança em escala | [azgovernance.com](https://azgovernance.com) |
...
| Azure SRE Agent Skills | Pack de skills proativas para o Azure SRE Agent. 8 skills cobrindo revisão WAF, compliance, planejamento de capacidade, FinOps, postmortems, Defender score, governança digital-native e postura AI | [github.com/ricmmartins/azure-sre-agent-skills](https://github.com/ricmmartins/azure-sre-agent-skills) |

---

## Blog Startups at Microsoft

Artigos publicados no blog oficial [Startups at Microsoft](https://techcommunity.microsoft.com/blog/startupsatmicrosoftblog) no Tech Community:
...
- [From zero to hero: Mastering storage in AKS](https://techcommunity.microsoft.com/blog/startupsatmicrosoftblog/from-zero-to-hero-mastering-storage-in-azure-kubernetes-service-aks/4397734)
- [From zero to hero with identity and access control in AKS](https://techcommunity.microsoft.com/blog/startupsatmicrosoftblog/from-zero-to-hero-with-identity-and-access-control-in-azure-kubernetes-service/4386350)
...
- [Azure Workbooks: Advanced Customization and Data Visualization](https://techcommunity.microsoft.com/blog/startupsatmicrosoftblog/azure-workbooks-advanced-customization-and-data-visualization-in-azure/4369588)
- [The importance of setting up service and resource health monitoring](https://techcommunity.microsoft.com/blog/startupsatmicrosoftblog/the-importance-of-setting-up-service-and-resource-health-monitoring-in-azure/4372478)
...
- [Introducing the Startup-Scale Landing Zone](https://techcommunity.microsoft.com/blog/startupsatmicrosoftblog/introducing-the-startup-scale-landing-zone-get-azure-right-from-day-one/4501566)
...
- [Azure capacity planning: Quotas, reservations, VMSS instance mix, and compute fleet](https://techcommunity.microsoft.com/blog/startupsatmicrosoftblog/azure-capacity-planning-using-quotas-reservations-vmss-instance-mix-and-compute-/4464893)
- [Azure Support Slack Bot on Azure Container Apps](https://techcommunity.microsoft.com/blog/startupsatmicrosoftblog/azure-support-slack-bot-on-azure-container-apps-production-ready-guide/4436423)
- [Dynamic Multi-Cloud Networking: BGP-Enabled VPN Between Azure and AWS](https://techcommunity.microsoft.com/t5/startups-at-microsoft/dynamic-multi-cloud-networking-configuring-a-bgp-enabled-vpn/ba-p/4281443)
- [How to easily set up a VPN between Azure and AWS using managed services](https://techcommunity.microsoft.com/t5/startups-at-microsoft/how-to-easily-set-up-a-vpn-between-azure-and-aws-using-managed/ba-p/4278966)
...
- [The Digital Native's Checklist for Azure](https://techcommunity.microsoft.com/blog/startupsatmicrosoftblog/the-digital-natives-checklist-for-azure-stuff-i-wish-every-startup-knew/4406669)
...
| Introduction to Azure DNS Private Resolver | [learn.microsoft.com](https://learn.microsoft.com/en-us/learn/modules/intro-to-azure-dns-private-resolver/) |
| Introduction to Azure Blueprints | [learn.microsoft.com](https://learn.microsoft.com/en-us/learn/modules/intro-to-azure-blueprints/) |
| Introduction to Azure Policy | [learn.microsoft.com](https://learn.microsoft.com/en-us/learn/modules/intro-to-azure-policy/) |
| Introduction to Azure Service Health | [learn.microsoft.com](https://learn.microsoft.com/en-us/learn/modules/intro-to-azure-service-health/) |
| Introduction to Azure Advisor | [learn.microsoft.com](https://learn.microsoft.com/en-us/learn/modules/intro-to-azure-advisor/) |
...
| Exam AZ-305 (Azure Solutions Architect Expert) | [aka.ms/az-305-training](https://aka.ms/az-305-training) |
| Exam AZ-400 (DevOps Solutions) | [aka.ms/az-400-training](https://aka.ms/az-400-training) |
...
| Guia Estudo Fundamentos AWS | PT-BR | [github.com/ricmmartins/guia-estudo-fundamentos-aws](https://github.com/ricmmartins/guia-estudo-fundamentos-aws) |
| Azure Readiness | EN | [aka.ms/azreadiness](https://aka.ms/azreadiness) |
| Azure Certification Guide | EN | [aka.ms/azcertification](https://aka.ms/azcertification) |
| Capacitação Azure | PT-BR | [aka.ms/capacitacaoazure](https://aka.ms/capacitacaoazure) |

---

## Red Hat e OpenShift

Contribuições para o Red Hat Cloud Experts Blog e documentação oficial do ARO na Microsoft:
...
- [Create an Azure Red Hat OpenShift 4 cluster](https://learn.microsoft.com/en-us/azure/openshift/tutorial-create-cluster) (Microsoft Docs)
- [ARO with Nvidia GPU Workloads](https://mobb.ninja/docs/aro/gpu/)
- [Use GPU workloads with Azure Red Hat OpenShift](https://learn.microsoft.com/en-us/azure/openshift/howto-gpu-workloads) (Microsoft Docs)
...
## Traduções Kubernetes (PT-BR)

Contribuições para a documentação oficial do Kubernetes em português:
...
- [Apache Guacamole on Azure](https://github.com/ricmmartins/apache-guacamole-azure)
- [Highly available WordPress on Azure](https://github.com/ricmmartins/highly-available-scalable-wordpress-azure/)
...
- [Azure Readiness](https://github.com/ricmmartins/AzureReadiness)
- [Azure Governance Made Simple](https://github.com/ricmmartins/azure-governance-made-simple)
- [FastTrack for Azure Sessions](https://github.com/ricmmartins/FTALive-Sessions)
- [Linux Training](https://github.com/ricmmartins/training)
...
> Todos os repositórios no meu [GitHub](https://github.com/ricmmartins?tab=repositories)
