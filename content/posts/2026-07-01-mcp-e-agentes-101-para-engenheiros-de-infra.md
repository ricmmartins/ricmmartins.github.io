...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 400" style="width:100%;height:auto" role="img" aria-label="Arquitetura MCP mostrando um Host com múltiplos MCP Clients, cada um conectado 1:1 a um MCP Server diferente">
<defs>
...
<text x="350" y="38" text-anchor="middle" font-size="13" font-weight="bold" fill="#1a3a5c">HOST (Claude, Copilot, Cursor, seu agent)</text>
...
<text x="350" y="395" text-anchor="middle" font-size="10" fill="#666">Cada client mantém conexão 1:1 com seu server</text>
</g>
</svg>
