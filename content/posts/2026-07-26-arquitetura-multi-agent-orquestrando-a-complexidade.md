...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 780 270" style="width:100%;height:auto" role="img" aria-label="Topologia orchestrator-workers com um orquestrador e três agentes especialistas">
  <defs>
  ...
  <g font-family="Segoe UI, Arial, sans-serif">
    ...
    <text x="390" y="50" text-anchor="middle" font-size="14" font-weight="bold" fill="#111111">Orchestrator</text>
    <text x="390" y="71" text-anchor="middle" font-size="10" font-weight="normal" fill="#555555">(coordena)</text>
    <path d="M 390 92 V 126 H 110 V 170" stroke="#666666" stroke-width="2" fill="none" marker-end="url(#arrow)"/>
    <path d="M 390 92 V 170" stroke="#666666" stroke-width="2" fill="none" marker-end="url(#arrow)"/>
    <path d="M 390 92 V 126 H 670 V 170" stroke="#666666" stroke-width="2" fill="none" marker-end="url(#arrow)"/>
    <rect x="40" y="170" width="140" height="74" rx="6" fill="#fff2cc" stroke="#d6b656" stroke-width="2"/>
    <text x="110" y="200" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">DB Agent</text>
    <text x="110" y="222" text-anchor="middle" font-size="10" font-weight="normal" fill="#555555">5 tools</text>
    <rect x="320" y="170" width="140" height="74" rx="6" fill="#d5e8d4" stroke="#82b366" stroke-width="2"/>
    <text x="390" y="200" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">Net Agent</text>
    <text x="390" y="222" text-anchor="middle" font-size="10" font-weight="normal" fill="#555555">5 tools</text>
    <rect x="600" y="170" width="140" height="74" rx="6" fill="#e1d5e7" stroke="#9673a6" stroke-width="2"/>
    <text x="670" y="200" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">K8s Agent</text>
    <text x="670" y="222" text-anchor="middle" font-size="10" font-weight="normal" fill="#555555">5 tools</text>
  </g>
</svg>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 850 165" style="width:100%;height:auto" role="img" aria-label="Pipeline de quatro estágios: collector, analyzer, planner e executor">
  ...
  <g font-family="Segoe UI, Arial, sans-serif">
    ...
    <text x="110" y="72" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">Collector</text>
    <text x="110" y="94" text-anchor="middle" font-size="10" font-weight="normal" fill="#555555">(gather)</text>
    <line x1="190" y1="82" x2="240" y2="82" stroke="#666666" stroke-width="2" fill="none" marker-end="url(#arrow)"/>
    <rect x="240" y="40" width="160" height="84" rx="6" fill="#dae8fc" stroke="#6c8ebf" stroke-width="2"/>
    <text x="320" y="72" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">Analyzer</text>
    <text x="320" y="94" text-anchor="middle" font-size="10" font-weight="normal" fill="#555555">(diagnose)</text>
    <line x1="400" y1="82" x2="450" y2="82" stroke="#666666" stroke-width="2" fill="none" marker-end="url(#arrow)"/>
    <rect x="450" y="40" width="160" height="84" rx="6" fill="#e1d5e7" stroke="#9673a6" stroke-width="2"/>
    <text x="530" y="72" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">Planner</text>
    <text x="530" y="94" text-anchor="middle" font-size="10" font-weight="normal" fill="#555555">(decide)</text>
    <line x1="610" y1="82" x2="660" y2="82" stroke="#666666" stroke-width="2" fill="none" marker-end="url(#arrow)"/>
    <rect x="660" y="40" width="160" height="84" rx="6" fill="#d5e8d4" stroke="#82b366" stroke-width="2"/>
    <text x="740" y="72" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">Executor</text>
    <text x="740" y="94" text-anchor="middle" font-size="10" font-weight="normal" fill="#555555">(act)</text>
  </g>
</svg>
