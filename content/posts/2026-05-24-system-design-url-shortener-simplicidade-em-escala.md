...
**tl;dr:** o encurtador parece simples, mas em produção o jogo é outro: geração de IDs sem colisão, redirect com cache agressivo, analytics assíncrono e expiração sem varrer o banco inteiro.
...
```sql
CREATE TABLE urls (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,  -- counter-based
...
Se alguém te desafiar com "Design a URL shortening service like Bitly or TinyURL.", a resposta final é essa: o sistema parece pequeno, mas vira um problema sério de cache, geração de IDs e analytics assíncrono.

## Leitura complementar

- [Redis data types](https://redis.io/docs/latest/develop/data-types/)
- [PostgreSQL identity columns](https://www.postgresql.org/docs/current/ddl-identity-columns.html)
- [HyperLogLog in Redis](https://redis.io/docs/latest/develop/data-types/probabilistic/hyperloglogs/)

---

*Esse foi o último artigo da série [System Design na Prática](/series/system-design-na-prática/). Se a série te ajudou, compartilha com outros devs que estão se preparando pra entrevistas. E se quiser que eu cubra outro sistema específico, me encontra no [LinkedIn](https://www.linkedin.com/in/ricmmartins/).*
