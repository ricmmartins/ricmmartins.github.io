...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 270" style="width:100%;height:auto" role="img" aria-label="Problema N por M com quatro aplicações de IA conectadas diretamente a quatro fontes de dados">
  <defs>
  ...
  <g font-family="Segoe UI, Arial, sans-serif">
    ...
    <text x="620" y="50" text-anchor="start" font-size="12" font-weight="bold" fill="#111111">Data Sources:</text>
    <line x1="190" y1="78" x2="620" y2="78" stroke="#999999" stroke-width="1.5" fill="none" />
    <line x1="190" y1="78" x2="620" y2="118" stroke="#999999" stroke-width="1.5" fill="none" />
    <line x1="190" y1="78" x2="620" y2="158" stroke="#999999" stroke-width="1.5" fill="none" />
    <line x1="190" y1="78" x2="620" y2="198" stroke="#999999" stroke-width="1.5" fill="none" />
    <line x1="190" y1="118" x2="620" y2="78" stroke="#999999" stroke-width="1.5" fill="none" />
    <line x1="190" y1="118" x2="620" y2="118" stroke="#999999" stroke-width="1.5" fill="none" />
    <line x1="190" y1="118" x2="620" y2="158" stroke="#999999" stroke-width="1.5" fill="none" />
    <line x1="190" y1="118" x2="620" y2="198" stroke="#999999" stroke-width="1.5" fill="none" />
    <line x1="190" y1="158" x2="620" y2="78" stroke="#999999" stroke-width="1.5" fill="none" />
    <line x1="190" y1="158" x2="620" y2="118" stroke="#999999" stroke-width="1.5" fill="none" />
    <line x1="190" y1="158" x2="620" y2="158" stroke="#999999" stroke-width="1.5" fill="none" />
    <line x1="190" y1="158" x2="620" y2="198" stroke="#999999" stroke-width="1.5" fill="none" />
    <line x1="190" y1="198" x2="620" y2="78" stroke="#999999" stroke-width="1.5" fill="none" />
    <line x1="190" y1="198" x2="620" y2="118" stroke="#999999" stroke-width="1.5" fill="none" />
    <line x1="190" y1="198" x2="620" y2="158" stroke="#999999" stroke-width="1.5" fill="none" />
    <line x1="190" y1="198" x2="620" y2="198" stroke="#999999" stroke-width="1.5" fill="none" />
    <rect x="40" y="62" width="150" height="30" rx="6" fill="#dae8fc" stroke="#6c8ebf" stroke-width="2"/>
    <text x="115" y="82" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">Claude</text>
    <rect x="40" y="102" width="150" height="30" rx="6" fill="#dae8fc" stroke="#6c8ebf" stroke-width="2"/>
    <text x="115" y="122" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">GPT</text>
    <rect x="40" y="142" width="150" height="30" rx="6" fill="#dae8fc" stroke="#6c8ebf" stroke-width="2"/>
    <text x="115" y="162" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">Copilot</text>
    <rect x="40" y="182" width="150" height="30" rx="6" fill="#dae8fc" stroke="#6c8ebf" stroke-width="2"/>
    <text x="115" y="202" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">Custom</text>
    <rect x="620" y="62" width="220" height="30" rx="6" fill="#fff2cc" stroke="#d6b656" stroke-width="2"/>
    <text x="730" y="82" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">GitHub</text>
    <rect x="620" y="102" width="220" height="30" rx="6" fill="#fff2cc" stroke="#d6b656" stroke-width="2"/>
    <text x="730" y="122" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">Jira</text>
    <rect x="620" y="142" width="220" height="30" rx="6" fill="#fff2cc" stroke="#d6b656" stroke-width="2"/>
    <text x="730" y="162" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">Azure Monitor</text>
    <rect x="620" y="182" width="220" height="30" rx="6" fill="#fff2cc" stroke="#d6b656" stroke-width="2"/>
    <text x="730" y="202" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">PostgreSQL</text>
    <text x="20" y="246" text-anchor="start" font-size="10" font-weight="normal" fill="#555555">4 apps × 4 sources = 16 integrações custom</text>
  </g>
</svg>

Com MCP:

<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 960 280" style="width:100%;height:auto" role="img" aria-label="Arquitetura N mais M com aplicações de IA conectadas a servidores MCP por um protocolo comum">
  <defs>
    <marker id="arrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="8" markerHeight="8" orient="auto-start-reverse">
      <path d="M 0 0 L 10 5 L 0 10 z" fill="#666666"/>
    </marker>
  ...
  <g font-family="Segoe UI, Arial, sans-serif">
    ...
    <rect x="390" y="120" width="180" height="60" rx="8" fill="#e1d5e7" stroke="#9673a6" stroke-width="2"/>
    <text x="480" y="147" text-anchor="middle" font-size="14" font-weight="bold" fill="#111111">MCP</text>
    <text x="480" y="167" text-anchor="middle" font-size="10" font-weight="normal" fill="#555555">protocolo padrão</text>
    <rect x="40" y="74" width="150" height="30" rx="6" fill="#dae8fc" stroke="#6c8ebf" stroke-width="2"/>
    <text x="115" y="94" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">Claude</text>
    <path d="M 190 90 H 300 V 150 H 390" stroke="#666666" stroke-width="2" fill="none" marker-end="url(#arrow)"/>
    <rect x="40" y="114" width="150" height="30" rx="6" fill="#dae8fc" stroke="#6c8ebf" stroke-width="2"/>
    <text x="115" y="134" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">GPT</text>
    <path d="M 190 130 H 300 V 150 H 390" stroke="#666666" stroke-width="2" fill="none" marker-end="url(#arrow)"/>
    <rect x="40" y="154" width="150" height="30" rx="6" fill="#dae8fc" stroke="#6c8ebf" stroke-width="2"/>
    <text x="115" y="174" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">Copilot</text>
    <path d="M 190 170 H 300 V 150 H 390" stroke="#666666" stroke-width="2" fill="none" marker-end="url(#arrow)"/>
    <rect x="40" y="194" width="150" height="30" rx="6" fill="#dae8fc" stroke="#6c8ebf" stroke-width="2"/>
    <text x="115" y="214" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">Custom</text>
    <path d="M 190 210 H 300 V 150 H 390" stroke="#666666" stroke-width="2" fill="none" marker-end="url(#arrow)"/>
    <rect x="700" y="74" width="220" height="30" rx="6" fill="#d5e8d4" stroke="#82b366" stroke-width="2"/>
    <text x="810" y="94" text-anchor="middle" font-size="11" font-weight="bold" fill="#111111">GitHub MCP Server</text>
    <path d="M 570 150 H 650 V 90 H 700" stroke="#666666" stroke-width="2" fill="none" marker-end="url(#arrow)"/>
    <rect x="700" y="114" width="220" height="30" rx="6" fill="#d5e8d4" stroke="#82b366" stroke-width="2"/>
    <text x="810" y="134" text-anchor="middle" font-size="11" font-weight="bold" fill="#111111">Jira MCP Server</text>
    <path d="M 570 150 H 650 V 130 H 700" stroke="#666666" stroke-width="2" fill="none" marker-end="url(#arrow)"/>
    <rect x="700" y="154" width="220" height="30" rx="6" fill="#d5e8d4" stroke="#82b366" stroke-width="2"/>
    <text x="810" y="174" text-anchor="middle" font-size="11" font-weight="bold" fill="#111111">Azure Monitor MCP Server</text>
    <path d="M 570 150 H 650 V 170 H 700" stroke="#666666" stroke-width="2" fill="none" marker-end="url(#arrow)"/>
    <rect x="700" y="194" width="220" height="30" rx="6" fill="#d5e8d4" stroke="#82b366" stroke-width="2"/>
    <text x="810" y="214" text-anchor="middle" font-size="11" font-weight="bold" fill="#111111">PostgreSQL MCP Server</text>
    <path d="M 570 150 H 650 V 210 H 700" stroke="#666666" stroke-width="2" fill="none" marker-end="url(#arrow)"/>
    <text x="20" y="258" text-anchor="start" font-size="10" font-weight="normal" fill="#555555">4 + 4 = 8 componentes (cada um implementa MCP uma vez)</text>
  </g>
</svg>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 470" style="width:100%;height:auto" role="img" aria-label="Arquitetura do protocolo MCP com host, cliente, transporte, servidor e capabilities">
  <defs>
    <marker id="arrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="8" markerHeight="8" orient="auto-start-reverse">
      <path d="M 0 0 L 10 5 L 0 10 z" fill="#666666"/>
    </marker>
  ...
  <g font-family="Segoe UI, Arial, sans-serif">
    ...
    <text x="450" y="118" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">MCP CLIENT</text>
    <text x="150" y="138" text-anchor="start" font-size="10" font-weight="normal" fill="#555555">- Descobre capabilities do server</text>
    <text x="150" y="154" text-anchor="start" font-size="10" font-weight="normal" fill="#555555">- Invoca tools</text>
    <text x="150" y="170" text-anchor="start" font-size="10" font-weight="normal" fill="#555555">- Acessa resources</text>
    <line x1="450" y1="170" x2="450" y2="260" stroke="#666666" stroke-width="2" fill="none" marker-end="url(#arrow)"/>
    ...
    <text x="450" y="360" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">Capabilities</text>
    ...
    <text x="230" y="387" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">Tools</text>
    <text x="230" y="402" text-anchor="middle" font-size="10" font-weight="normal" fill="#555555">(ações)</text>
    <text x="450" y="387" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">Resources</text>
    <text x="450" y="402" text-anchor="middle" font-size="10" font-weight="normal" fill="#555555">(dados)</text>
    <text x="670" y="387" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">Prompts</text>
    <text x="670" y="402" text-anchor="middle" font-size="10" font-weight="normal" fill="#555555">(templates)</text>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 760 220" style="width:100%;height:auto" role="img" aria-label="Fluxo stdio local com host process, MCP client e MCP server process">
  ...
  <g font-family="Segoe UI, Arial, sans-serif">
    ...
    <text x="200" y="120" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">MCP Client</text>
    <rect x="460" y="90" width="250" height="50" rx="6" fill="#d5e8d4" stroke="#82b366" stroke-width="2"/>
    <text x="585" y="120" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">MCP Server process</text>
    <line x1="310" y1="115" x2="460" y2="115" stroke="#666666" stroke-width="2" fill="none" marker-end="url(#arrow)"/>
    <text x="385" y="100" text-anchor="middle" font-size="10" font-weight="normal" fill="#555555">spawns</text>
    <line x1="460" y1="165" x2="310" y2="165" stroke="#666666" stroke-width="2" fill="none" marker-start="url(#arrow)" marker-end="url(#arrow)"/>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 780 220" style="width:100%;height:auto" role="img" aria-label="Fluxo HTTP com SSE em que o MCP client abre stream e envia mensagens JSON-RPC">
  ...
  <g font-family="Segoe UI, Arial, sans-serif">
    ...
    <text x="595" y="88" text-anchor="middle" font-size="12" font-weight="bold" fill="#111111">Remote MCP endpoint</text>
    <text x="595" y="108" text-anchor="middle" font-size="10" font-weight="normal" fill="#555555">SSE + JSON-RPC</text>
    <line x1="310" y1="105" x2="470" y2="85" stroke="#666666" stroke-width="2" fill="none" marker-end="url(#arrow)"/>
    ...
    <line x1="310" y1="125" x2="470" y2="125" stroke="#666666" stroke-width="2" fill="none" marker-end="url(#arrow)"/>
